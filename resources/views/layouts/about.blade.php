      ...
      <section class="section section-sm text-center text-lg-start">
        <div class="container">
          <div class="row row-50">
            ...
            <div class="col-lg-6">
            <p>Rightway Future is a company designed to make a profit for the owners of the company and a few individual participants at the top levels of the MLM pyramid of participants.
            <br>
