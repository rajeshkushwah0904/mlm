...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Distributor Downline List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Distributor Downline List</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card" style="overflow-x:scroll;">
                        <div class="card-header">
                            <h3 class="card-title">Downline Distributor List</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
function search_function() {
    ...
    $.ajax({
        url: "{{route('backend.distributors.distributor_downline_filter_data')}}",
        data: {
            "_token": "{{ csrf_token() }}",
