                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item"
                                                            href="{{route('backend.banks.edit',$bank->id)}}">View</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
                                                            href="{{route('backend.banks.approved',$bank->id)}}">Approved</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
                                                            href="{{route('backend.banks.rejected',$bank->id)}}">Rejected</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
