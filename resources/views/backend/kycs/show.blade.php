        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="aadhaarcard_no" class="form-control" value="{{$kyc->aadhaarcard_no}}"
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Aadhar Card</label>
                    <input type="number" name="aadhaarcard_no" class="form-control" value="{{$kyc->aadhaarcard_no}}"
                        id="exampleInputEmail1" placeholder="Enter Aadhar Card" readonly>
                </div>
                @endif
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_holder_name" value="{{$kyc->account_holder_name}}"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select type="text" name="account_type" value="{{old('account_type')}}" class="form-control"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="bank_name" value="{{$kyc->bank_name}}" class="form-control"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="bank_branch" value="{{$kyc->bank_branch}}" class="form-control"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Bank Branch</label>
                            <input type="text" name="bank_branch" value="{{$kyc->bank_branch}}" class="form-control"
                                id="exampleInputEmail1" placeholder="Enter Bank Branch" readonly>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <img src="{{asset($kyc->aadhaar_card_file)}}" style="width: 100%" data-toggle="modal"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <img src="{{asset($kyc->bank_document)}}" style="width: 100%" data-toggle="modal"
