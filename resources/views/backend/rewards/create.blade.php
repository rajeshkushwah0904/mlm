                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="criteria" class="form-control"
                                            value="{{old('criteria')}}" id="exampleInputEmail1"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="reward" class="form-control" value="{{old('reward')}}"
                                            id="exampleInputEmail1" placeholder="Enter Reward" Required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Business Amount </label>
                                        <input type="number" name="business_amount" value="{{old('business_amount')}}"
                                ...
                                <div class=" col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cash" value="{{old('cash')}}" class="form-control"
