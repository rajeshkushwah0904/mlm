         ...
         <div class="rd-navbar-inner">
             ...
             <div class="rd-navbar-panel">
                 ...
                 <div class="rd-navbar-brand">
                     <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark"
                             src="{{asset('images\rightway_futurel_logo.jpg')}}" alt="" width="155" height="35" /><img
                             class="brand-logo-light" src="{{asset('images\rightway_futurel_logo.jpg')}}" alt=""
             ...
             <div class="rd-navbar-nav-wrap"><a class="fa-shopping-cart" href="shopping-cart.html"></a>
                 ...
                 <ul class="rd-navbar-nav">
                     ...
                     <li class="rd-nav-item"><a class="rd-nav-link" href="#">Product</a></li>
