          ...
          <div class="row row-30">
            <div class="col-lg-4 text-center text-lg-start">
              <address class="contact-block">
                <dl>
                  ...
                  <dd>C-9, Hanuman Colony Gole Ka Mandir
                     Gwalior,Madhya Pradesh-474005</dd>
                  <dt class="heading-6">PHONE</dt>
                  <dd><a href="tel:#">7880006260</a></dd>
            ...
            <div class="col-lg-8">
              <div class="button-shadow py-5 px-3 round-large">
                ...
                <form class="rd-mailform text-start" data-form-output="form-output-global" data-form-type="forms" method="post" action="bat/rd-mailform.php">
                  <div class="row row-20 align-items-end">
                    <div class="col-md-6">
                      <div class="form-wrap form-wrap-validation validation-with-outside-label">
                        ...
                        <input class="form-input" id="forms-name" type="text" name="name" placeholder="Your Name" data-constraints="@Required">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-wrap form-wrap-validation validation-with-outside-label">
                        <label class="form-label-outside" for="forms-last-name">Your Mobile No.</label>
                        <input class="form-input" id="forms-last-name" type="text" name="last-name" placeholder="Your Mobile No." data-constraints="@Required">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-wrap form-wrap-validation validation-with-outside-label">
                        <label class="form-label-outside" for="forms-message">Enter Your Comment</label>
                        <textarea class="form-input" id="forms-message" name="message" placeholder="Enter Your Comment" data-constraints="@Required"></textarea>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-wrap form-wrap-validation validation-with-outside-label">
