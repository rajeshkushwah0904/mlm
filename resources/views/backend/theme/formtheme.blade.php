...
<head>
    ...
    <link rel="stylesheet"
        href="{{asset('backendtheme/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css')}}">
    ...
    <link rel="stylesheet"
        href="{{asset('backendtheme/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css')}}">
    <!-- Theme style -->
