...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>All Repurchase Income List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">All Repurchase Income List</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">All Repurchase Income List</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <th>Sponsor Tracking ID
                                            ...
                                            <div class="form-group">
                                                <select class="form-control select2" name="sponsor_id"
                                                    style="width: 100%;" onchange="submit();">
                                                    <option value="">All</option>
                                                    @foreach($distributors as $distributor)
                                                    <option value="{{$distributor->id}}"
                                                        {{"$distributor->id" == $sponsor_id ? 'selected' : ''}}>
                                                        {{$distributor->distributor_tracking_id}} (
                                                        {{$distributor->name}} )
                                                    </option>
                                                    @endforeach
                                                </select>
