    ...
    <section>
        ...
        <div class="swiper-container swiper-slider" data-swiper='{"autoplay":{"delay":5000},"effect":"fade"}'>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide" data-slide-bg="{{asset('images/header-internal1.jpg')}}">
                    <div class="swiper-slide-caption"></div>
                </div>
                <div class="swiper-slide" data-slide-bg="{{asset('images/header-internal2.jpg')}}">
                    <div class="swiper-slide-caption"></div>
                </div>
                <div class="swiper-slide" data-slide-bg="{{asset('images/header-internal3.jpg')}}">
                    <div class="swiper-slide-caption"></div>
                </div>
            </div>
        </div>
