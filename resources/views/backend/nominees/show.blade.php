 <h3 class="text-center"> Nominee Deatil</h3>
 {!!Form::open(['route'=>['backend.nominees.edit',$nominee->id],'files'=>true,'class'=>'form-horizontal'])!!}
 {{csrf_field()}}
 <div class="row">
     <div class="col-md-3">
         <div class="card card-default">
             ...
             <div class="card-body">
                 ...
                 <div class="form-group">
                     ...
                     <input type="text" name="pancard_no" value="{{$nominee->pancard_no}}" class="form-control"
                 ...
                 <div class="form-group">
                     ...
                     <input type="number" name="aadhaarcard_no" class="form-control"
                         value="{{$nominee->aadhaarcard_no}}" id="exampleInputEmail1" placeholder="Enter Aadhar Card"
                         required>
                 </div>
                 @else
                 <div class="form-group">
                 ...
                 <div class="row">
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <input type="text" name="account_holder_name" value="{{$nominee->account_holder_name}}"
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <input type="number" name="account_number" class="form-control"
                                 value="{{$nominee->account_number}}" id="exampleInputEmail1"
                         ...
                         <div class="form-group">
                             ...
                             <select type="text" name="account_type" value="{{old('account_type')}}"
                                 ...
                                 <option value="Saving Account"
                                     {{"Saving Account" == $nominee->account_type ? 'selected' : ''}}>Saving
                                     Account</option>
                                 <option value="Current Account"
                                     {{"Current Account" == $nominee->account_type ? 'selected' : ''}}>Current
                                     Account</option>
                                 <option value="Recurring Account"
                                     {{"Recurring Account" == $nominee->account_type ? 'selected' : ''}}>
                                     Recurring
                                     Account</option>
                             </select>
                 ...
                 <div class="row">
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <input type="text" name="ifsc_code" class="form-control" value="{{$nominee->ifsc_code}}"
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <input type="text" name="bank_name" value="{{$nominee->bank_name}}" class="form-control"
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <input type="text" name="bank_branch" value="{{$nominee->bank_branch}}"
                                 class="form-control" id="exampleInputEmail1" placeholder="Enter Bank Branch" required>
                         </div>
                     </div>
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <input type="text" name="account_type" class="form-control"
                                 value="{{$nominee->account_type}}" id="exampleInputEmail1" placeholder="Enter Amount"
                                 readonly>
                         </div>
                     </div>
                 </div>
                 <div class="row">
                     <div class="col-md-4">
                         <div class="form-group">
                             <label for="exampleInputEmail1">IFSC Code</label>
                             <input type="text" name="ifsc_code" class="form-control" value="{{$nominee->ifsc_code}}"
                                 id="exampleInputEmail1" placeholder="Enter Amount" readonly>
                         </div>
                     </div>
                     <div class="col-md-4">
                         <div class="form-group">
                             <label for="exampleInputEmail1">Bank Name</label>
                             <input type="text" name="bank_name" value="{{$nominee->bank_name}}" class="form-control"
                                 id="exampleInputEmail1" placeholder="Bank Name" readonly>
                         </div>
                     </div>
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             <label for="exampleInputEmail1">Bank Branch</label>
                             <input type="text" name="bank_branch" value="{{$nominee->bank_branch}}"
                                 class="form-control" id="exampleInputEmail1" placeholder="Enter Bank Branch" readonly>
                         </div>
                     </div>
 ...
 <div class="row">
     <div class="col-md-12">
         <div class="card card-default">
             <div class="card-header">
                 <h3 class="card-title">Nominee Uploaded documents</h3>
             </div>
             <div class="card-body">
                 <div class="row">
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <img src="{{asset($nominee->pancard_file)}}" style="width: 100%" data-toggle="modal"
                                 ...
                                 <div class="modal-dialog modal-lg">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-body">
                                             <img src="{{asset($nominee->pancard_file)}}" style="width: 100%">
                                         </div>
                                     </div>
                                 </div>
                             </div>
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <img src="{{asset($nominee->aadhaar_card_file)}}" style="width: 100%" data-toggle="modal"
                                 data-target="#aadhaar_card_file">
                             <div class="modal fade" id="aadhaar_card_file">
                                 <div class="modal-dialog modal-lg">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-body">
                                             <img src="{{asset($nominee->aadhaar_card_file)}}" style="width: 100%">
                                         </div>
                                     </div>
                                 </div>
                             </div>
                         ...
                         @if($nominee->backend_aadhaar_card_file)
                         <div class="form-group">
                             <label for="exampleInputEmail1">Backend Aadhaar Card Image</label>
                             <img src="{{asset($nominee->backend_aadhaar_card_file)}}" style="width: 100%"
                             ...
                             <div class="modal fade" id="backend_aadhaar_card_file">
                                 <div class="modal-dialog modal-lg">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-body">
                                             <img src="{{asset($nominee->backend_aadhaar_card_file)}}"
                                                 style="width: 100%">
                                         </div>
                                     </div>
                                 </div>
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                             ...
                             <img src="{{asset($nominee->bank_document)}}" style="width: 100%" data-toggle="modal"
                                 data-target="#bank_document">
                             <div class="modal fade" id="bank_document">
                                 <div class="modal-dialog modal-lg">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-body">
                                             <img src="{{asset($nominee->bank_document)}}" style="width: 100%">
                                         </div>
                                     </div>
                                 </div>
                             </div>
