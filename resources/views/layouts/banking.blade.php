        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-xl-6 bg-default text-center">
              ...
              <p class="lead">We worked out an amazing combination of vast functionality and user's comfort. It will totally impress you with its power!</p>
            </div>
          </div>
          <div class="row margin-1 row-11">
            <div class="col-md-6">
              <div class="box-sm box-skin-1 bg-lighter box-skin-left-offset-negative">
                ...
                <div class="box__body box__middle">
                  <h5><a href="#">SBI</a></h5>
                  <p>
                  <li>Account Holder Name: Fiona Ledner</li>
                  <li>Branch Name: Fatehgunj</li>
                  <li>Account Type: Current</li>
                  <li>Account Number: 3610130022876908</li>
                  <li>IFSC code: HBDY6125362</li>
                </p>
            ...
            <div class="col-md-6">
              <div class="box-sm box-skin-1 bg-lighter box-skin-right-offset-negative">
                <div class="box__left box-md-inset-1"><span class="icon icon-md icon-primary line-height-1 fa-rocket"></span></div>
                <div class="box__left box__middle">
                  <h5><a href="#"><i class="uil uil-university"></i>ICICI</a></h5>
                  <p>
                  <li>Account Holder Name: Fiona Ledner</li>
                  <li>Branch Name: Fatehgunj</li>
                  <li>Account Type: Current</li>
